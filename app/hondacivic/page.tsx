    ...
    return(
        <div>
            <div className="text-center">
               <div className="text-white text-5xl font-bold py-2">Honda Civic </div>

               <div className="flex justify-center items-center py-10 px-10">
               <img src="https://cache4.pakwheels.com/system/car_generation_pictures/7370/medium/Cover.jpg?1677570254"
                alt="Honda Civic" width={420} className="border-black"></img>
               </div>
